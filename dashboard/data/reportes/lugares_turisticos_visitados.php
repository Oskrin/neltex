<?php
    ...
    class PDF extends FPDF {   
        ...
        function Header() {             
            ...
            $this->Cell(150, 5, "LUGARES TURISTICOS MAS VISITADOS", 0,1, 'R', 0);      
    ...
    $pdf->SetX(5);
    $resultado = $class->consulta("SELECT E.id, E.nombre, E.propietario, E.direccion, E.correo, COUNT(E.id) AS Total   FROM rutas_trazadas R , lugar_turistico E WHERE R.id_llegada = E.id AND R.fecha_creacion between '".$_GET['fecha_inicio']."' AND '".$_GET['fecha_fin']."' GROUP BY E.id, E.nombre, E.propietario, E.direccion, E.correo  ORDER BY COUNT(E.id) DESC");
