            ...
            <div class="col-sm-12">
                <div class="hpanel">
                    <div class="panel-heading">
                        ...
                        Formulario Eventos / <small>todos los campos marcados con (*) son obligatorios</small>
                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" id="form-data" enctype='multipart/form-data'>
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="col-sm-12 control-label">Nombre Evento (*)</label>
                                        <div class="col-sm-12">
                                            <input type="text" id="txt_1" name="txt_1" class="form-control" placeholder="Nombre Evento" />
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="col-sm-12 control-label">Fecha Evento (*)</label>
                                        <div class="col-sm-12">
                                            <input type="text" id="txt_2" name="txt_2" class="form-control datepicker" placeholder="Fecha Evento">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="col-sm-12 control-label">Hora Evento (*)</label>
                                        <div class="col-sm-12">
                                            <input type="text" id="txt_3" name="txt_3" class="form-control" placeholder="Hora Evento">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">                                
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                        <textarea rows="3" cols="50" class="form-control" id="txt_4" name="txt_4" placeholder="Descripción Establecimiento"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <!--<div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12 text-center">
                                    <button class="btn w-xs btn-info" type="button" name="btn_guardar" id="btn_guardar">Guardar</button>
                                    <!--<button class="btn w-xs btn-info" type="button" name="btn_modificar" id="btn_modificar">Modificar</button>-->
                                </div>
                            </div>
                        </form>
                    </div>
