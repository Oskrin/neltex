            ...
            <div class="col-sm-12">
                <div class="hpanel">
                    <div class="panel-heading">
                        ...
                        Formulario Reportes Rutas
                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" id="form-data">
                            <div class="col-sm-4">
                                <h1>ESTABLECIMIENTOS MAS VISITADOS</h1>
                                <div class="form-group">
                                    <label class="control-label col-xs-12 col-sm-4 no-padding-right">Fecha Inicio:</label>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="input-group">
                                            <input type="text" id="txt_1" name="txt_1" class="form-control datepicker" />
                                ...
                                <div class="form-group">
                                    <label class="control-label col-xs-12 col-sm-4 no-padding-right">Fecha Fin:</label>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="input-group">
                                            <input type="text" id="txt_2" name="txt_2" class="form-control datepicker" />
                                            <span class="input-group-addon">
                                                <i class="ace-icon fa fa-calendar"></i>
                                            </span>
                                        </div>
                                ...
                                <div class="form-group" style="display: none">
                                    <label class="control-label col-xs-12 col-sm-4 no-padding-right">Limite:</label>
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="clearfix">
                                            <input type="number" name="txt_3" id="txt_3" class="form-control" value="0" min="0" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <button class="btn w-xs btn-info" type="button" name="btn_establecimientos" id="btn_establecimientos">Generar</button>
                                    </div>
                                </div>   
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="input-group">
                                            <input type="text" id="txt_4" name="txt_4" class="form-control datepicker" />
                                            <span class="input-group-addon">
                                                <i class="ace-icon fa fa-calendar"></i>
                                            </span>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="input-group">
                                            <input type="text" id="txt_5" name="txt_5" class="form-control datepicker" />
                                            <span class="input-group-addon">
                                                <i class="ace-icon fa fa-calendar"></i>
                                            </span>
                                        </div>
                                ...
                                <div class="form-group" style="display: none">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="clearfix">
                                            <input type="number" name="txt_6" id="txt_6" class="form-control" value="0" min="0" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <button class="btn w-xs btn-info" type="button" name="btn_lugares" id="btn_lugares">Generar</button>
                                    </div>
                                </div>   
                            </div>                            
                        </form>
