	...
	//////////////para tablas//////////
	    ...
	    jQuery(grid_selector).jqGrid({	       
	        ...
	        datatype: "xml",
	        height: 250,
	        colNames:['ID','PORCENTAJE','FECHA'],
	        colModel:[
	            {name:'id_iva',index:'id_iva', width:60, sorttype:"int", editable: true, hidden: true, editoptions: {readonly: 'readonly'}},
	    ...
	    },
	    {
			...
			if(response.responseText == 3){
	        		...
	        		if(response.responseText == 1){	
	        			$("#nombre_marca").val("");
	        			return [false,"Error.. El Iva ya existe"];
		        	}	
	        	}
	        },
	    },
